...
class StarsControllerTest < ActionController::TestCase
  ...
  test "should create star" do
    assert_difference('Star.count') do
      post :create, star: { post_type: @star.post_type, text: @star.text, ts: @star.ts, user: @star.user }
    end
  ...
  test "should update star" do
    patch :update, id: @star, star: { post_type: @star.post_type, text: @star.text, ts: @star.ts, user: @star.user , ts_date: @star.ts_date, ch_id: @star.ch_id }
    assert_redirected_to star_path(assigns(:star))
  end
